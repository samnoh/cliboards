...
<head>
    ...
    <style>
        body { background: #2B292D; padding-bottom: 60px; padding: 0; margin: 0; flex; align-items: center; justify-content: center; flex-direction: column; width: 80%; margin: 0 auto; }
